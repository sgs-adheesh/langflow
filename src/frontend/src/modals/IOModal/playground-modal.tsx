...
import { BrandButtonRedirectTarget } from "@/customization/utils/urls";
...
export default function IOModal({
  ...
  const handleBrandingClick = () => {
    track("BrandButtonClick");
    customOpenNewTab(BrandButtonRedirectTarget());
  };
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    >
                      ...
                      />
                      <div className="text-sm">Built with {BRAND_NAME}</div>
                    </Button>
                  </div>
                )}
              </div>
              ...
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                ...
                >
                  <Button
                    ...
                    onClick={handleBrandingClick}
                  >
                    <IconComponent name="Sparkles" className="h-[18px] w-[18px]" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
