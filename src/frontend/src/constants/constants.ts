...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  `Edit your Python code snippet. Refer to the ${BRAND_DOCS_REFERENCE} for more information on how to write your own component.`;
...
export const DESCRIPTIONS: string[] = [
  ...
  `${BRAND_NAME}: Create, Chain, Communicate.`,
...
export const API_PAGE_PARAGRAPH =
  `Your secret ${BRAND_NAME} API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.`;
...
export const LANGFLOW_CHAT_TITLE = BRAND_CHAT_TITLE;
...
export const STORE_TITLE = BRAND_STORE_NAME;
...
export const CREATE_API_KEY = `Need an API key? Contact your administrator.`;
...
export const DOCS_URL = BRAND_DOCS_URL;
