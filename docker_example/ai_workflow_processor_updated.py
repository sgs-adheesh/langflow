    ...
    async def _process_components(
        ...
        for i, component in enumerate(components):
            try:
                ...
                # Get the component type from the AI suggestion
                ...
                if not component_template:
                    node = {
                        ...
                        "data": {
                            ...
                            "original_component_id": component.get("id"),
                        },
                    }
                else:
        ...
        for i, connection in enumerate(connections):
            try:
                ...
                if from_component_id not in node_map:
                    raise ValueError(f"Source component '{from_component_id}' not found")
                    
                if to_component_id not in node_map:
                    raise ValueError(f"Target component '{to_component_id}' not found")
